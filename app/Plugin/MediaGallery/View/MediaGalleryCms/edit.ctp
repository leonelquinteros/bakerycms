...
<div id="bakery-actions">
    <div class="bakery-action-box">
        ...
        <div class="bakery-action-box-content">
            <p class="bakery-action-boxButtons">
                ...
                <br />
                <a href="<?php echo $this->Html->url('/cms/media_gallery'); ?>" class="button-large"><?php echo __d('cms', 'Back to gallery');?></a>
            </p>
        </div>
    ...
    if(substr($this->data['MediaGalleryFile']['filetype'], 0, 5) == 'image')
    {
        ...
        <div class="bakery-action-box">
            ...
            <div class="bakery-action-box-content">
                <p class="bakery-action-boxButtons">
                    <a href="<?php echo $this->Html->url('/cms/media_gallery/crop/' . $this->data['MediaGalleryFile']['id']); ?>" id="btnCrop" class="button-large">Crop image</a>
                </p>
            </div>
            <div class="bakery-action-box-bottom"></div>
        </div>
...
<div id="bakery-main">
    <div id="bakery-form">
        <form id="frmMediaGallery" action="<?php echo $this->Html->url('/cms/media_gallery/edit/' . $this->data['MediaGalleryFile']['id']); ?>" method="post" enctype="multipart/form-data">
        ...
        if(substr($this->data['MediaGalleryFile']['filetype'], 0, 5) == 'image')
        {
            ...
            <div class="bakery-form-footer">
                <a href="<?php echo $this->Html->url('/cms/media_gallery/crop/' . $this->data['MediaGalleryFile']['id']); ?>" id="btnCrop" class="button-medium">Crop image</a>
            </div>
            <?php
        }
